...
SAFE_R = 50.0            # beyond this radius the ground is indestructible (trees stand past it)
...
class Ground:
    def __init__(self, feet=()):
        """feet: (x0, x1, y0, y1) boxes where the ground is kept (no floating legs under standing giants)."""
        n = 2 * REG
    ...
    def release(self, key):
        """A giant has gone: the ground under its feet can be blown up too."""
