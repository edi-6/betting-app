...
CLEARING = 52.0          # a wide clearing in the forest for the four giants (same world as the last video)
...
def make_renderer(width=1080, height=1920, ss=1.0, shadow_res=4096, sky_res=(8192, 2048)):
    ...
    r.add_prop_kind('block', BL.build_mesh(), BL.texture_layers(), sheen=-2.0)
